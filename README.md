...
$R = \mathcal{H}_{i,\alpha}(X) = \frac{1}{1-\alpha} \log\left(\sum_{j=1}^n p_j^\alpha \right), \; i \in \{1, \dots, n\}$
...
Можем также посмотреть на примеры поведения двух моделей и точность их вычисления.
